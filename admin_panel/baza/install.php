...
<div class="container">
  ...
  <form method="post" action="">
	...
	<div class="form-group">
      ...
      <input type="text" class="form-control" id="ipadresa" placeholder="Unesi IP adresu" name="ipadresa">
    </div>
	
	<div class="form-group">
      <label for="base">Korisničko ime baze:</label>
      <input type="text" class="form-control" id="base" placeholder="Unesi ime za bazu" name="base">
    </div>
	...
	<div class="form-group">
      <label for="baza">Ime za Bazu:</label>
      <input type="text" class="form-control" id="baza" placeholder="Unesi ime baze" name="baza">
    </div>
