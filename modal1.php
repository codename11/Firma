			...
			<div class="modal-body">
				<div class="container-fluid text-center" style="font-family:Palatino Linotype;">
					<form id="F3">
						...
						<button type="button" id="submit" style="margin-top: 10px" name="submit" class="btn btn-default" data-dismiss="modal" onclick="serializationx('adminV2.php',this)">Izmeni</button>	
					</form>	
			</div> 
			</div>
